      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Value value={getDisplayBalance(stakedBalance, bank.depositToken.decimal, 10)} />
          ...
          <StyledCardActions>
                ...
                <IconButton
                  ...
                  onClick={() => (approveStatus === ApprovalState.APPROVED ? (bank.finished ? null : onPresentDeposit()) : approve())}
                >
                  <AddIcon />
                </IconButton>
          </StyledCardActions>
